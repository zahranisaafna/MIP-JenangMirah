...
<div class="min-h-screen bg-gray-50 p-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Beranda Owner</h1>
...
<script>
    ...
    function updateCharts() {
        ...
        window.location.href = `{{ route('owner.dashboard') }}?periode=${periode}&start_date=${startDate}&end_date=${endDate}`;
    }
</script>
@endpush
{{-- @extends('layouts.master')
...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-fw fa-tachometer-alt"></i> Beranda Owner
        </h1>
